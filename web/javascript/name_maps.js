...
export const shapefileTypes = {
  ...
  'Highway Flows (Interstate)': 'highway',
  'Highway Flows (SU)': 'highway',
  'Highway Flows (CU)': 'highway',
  'Operational Electrolyzers': 'point',
  'Installed Electrolyzers': 'point',
  'Planned Electrolyzers': 'point',
  'Hydrogen from Refineries': 'point',
  'DCFC Chargers': 'point',
  'Hydrogen Stations': 'point',
  'LNG Stations': 'point',
  'CNG Stations': 'point',
  'LPG Stations': 'point',
  'East Coast ZEV Corridor': 'highway',
  'Midwest ZEV Corridor': 'highway',
  'Houston to LA H2 Corridor': 'highway',
  'I-710 EV Corridor': 'highway',
  'Northeast EV Corridor': 'area',
  'Bay Area EV Roadmap': 'area',
  'Salt Lake City Region EV Plan': 'area',
  'Truck Stop Locations': 'point',
  'Principal Ports': 'point'
};
