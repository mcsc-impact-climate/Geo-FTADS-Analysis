...
GREET_classes_dict = {1: "Heavy GVW", 2: "Medium GVW", 3: "Light GVW", 4: "Light-duty"}
...
FAF5_VIUS_commodity_map = {
    ...
    "Coal": {"VIUS": ["PCOAL"], "FAF5": ["Coal"], "short name": "coal"},
    "Crude petroleum": {
        "VIUS": ["PCRUDEPETRLM"],
        "FAF5": ["Crude petroleum"],
        "short name": "crude_petroleum",
    },
    "Gasoline": {"VIUS": ["PGASOLINE"], "FAF5": ["Gasoline"], "short name": "gasoline"},
    "Fuel oils": {
        "VIUS": ["PFUELOIL"],
        "FAF5": ["Fuel oils"],
    ...
    "Logs": {"VIUS": ["PLOGS"], "FAF5": ["Logs"], "short name": "logs"},
    "Wood products": {
